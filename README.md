# 🏥 LifeSave Assistant for Indian Rural Communities

> Offline-first health advisor. Generates SMS/telephony alert templates for critical patient triage.
...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/lifesave-rural-assistant/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-lifesave-rural-assistant.git
cd tp-lifesave-rural-assistant
```
...
```bash
kubectl port-forward deployment/tp-lifesave-rural-assistant 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── lifesave_assistant.py     # Main configuration file
```
...
---
*Generated by [LifeSave Assistant for Indian Rural Communities Studio](https://pradeeptalari14.github.io/portfolio/tools/lifesave-rural-assistant/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
